...
public class AgendaCalendarView extends FrameLayout implements StickyListHeadersListView.OnStickyHeaderChangedListener {
    ...
    public AgendaCalendarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView, 0, 0);
        mAgendaCurrentDayTextColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_agendaCurrentDayTextColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.theme_primary));
        mCalendarHeaderColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_calendarHeaderColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.theme_primary_dark));
        mCalendarBackgroundColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_calendarColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.theme_primary));
        mCalendarDayTextColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_calendarDayTextColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.theme_text_icons));
        mCalendarCurrentDayColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_calendarCurrentDayTextColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.calendar_text_current_day));
        mCalendarPastDayTextColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_calendarPastDayTextColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.theme_light_primary));
        mFabColor = a.getColor(com.github.tibolte.agendacalendarview.R.styleable.ColorOptionsView_fabColor, getResources().getColor(com.github.tibolte.agendacalendarview.R.color.theme_accent));

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(com.github.tibolte.agendacalendarview.R.layout.view_agendacalendar, this, true);
    ...
    protected void onFinishInflate() {
        ...
        mCalendarView = (CalendarView) findViewById(com.github.tibolte.agendacalendarview.R.id.calendar_view);
        mAgendaView = (AgendaView) findViewById(com.github.tibolte.agendacalendarview.R.id.agenda_view);
        mFloatingActionButton = (FloatingActionButton) findViewById(com.github.tibolte.agendacalendarview.R.id.floating_action_button);
        ColorStateList csl = new ColorStateList(new int[][]{new int[0]}, new int[]{mFabColor});
        mFloatingActionButton.setBackgroundTintList(csl);

        mCalendarView.findViewById(com.github.tibolte.agendacalendarview.R.id.cal_day_names).setBackgroundColor(mCalendarHeaderColor);
        mCalendarView.findViewById(com.github.tibolte.agendacalendarview.R.id.list_week).setBackgroundColor(mCalendarBackgroundColor);
